...
CREATE TABLE `categorie` (
  `id` int NOT NULL AUTO_INCREMENT,
  `categorie_name` enum('Action','Fantaisie','Romance','Yaoi','Aventure','Horreur','Seinen','Yuri','Combats','Isekai','Shônen','Comédie','Jôsei','Shôjo','Drame','Mystère','Sport','Ecchi','Psychologique','Surnaturel','Ecole','Quotidien','Tournois') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `genre` (
  `id` int NOT NULL AUTO_INCREMENT,
  `genre_name` enum('Anime','Manga','Film','VOSTFR','VF') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-07-19 11:40:21
